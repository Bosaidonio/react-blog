 ...
 * @LastEditTime: 2022-01-10 18:41:14
 * @LastEditors: Mario
 * @Description: 头部组件
 */
...
import { SearchOutlined, LoadingOutlined, CaretDownOutlined } from '@ant-design/icons'
...
const Header = () => {
    ...
    audio: [
      {
        name: '嘉宾',
        artist: '路飞文',
        url: 'https://mariowork.com/static/嘉宾.mp3',
        cover: 'https://mariowork.com/static/嘉宾.jpeg',
        lrc: 'https://mariowork.com/static/嘉宾.lrc',
        theme: '#ebd0c2',
      },
      {
        name: '十一种孤独',
        artist: '宿羽阳',
        url: 'https://mariowork.com/static/十一种孤独.mp3',
        cover: 'https://mariowork.com/static/十一种孤独.png',
        lrc: 'https://mariowork.com/static/十一种孤独.lrc',
        theme: '#ebd0c2',
      },
      {
        name: '窗',
        artist: '虎二',
        url: 'https://mariowork.com/static/窗.mp3',
        cover: 'https://mariowork.com/static/窗.png',
        lrc: 'https://mariowork.com/static/窗.lrc',
        theme: '#ebd0c2',
      },
    ],
  }
  ...
  return (
    <header className={classnames('flex', styles['bg-header'], 'bg')}>
      <div className={classnames('w-220', styles.logo)}>
